                                ...
                                <td style="text-align: center">
                                    ...
                                    @if($tt->nhanhoso == 'DANGNHAN')
                                        ...
                                        @if($tt->hosodonvi > 0 && in_array($tt->trangthai, ['CC','BTL']))
                                            <button title="Trình hồ sơ đăng ký" type="button" onclick="getIdTr('{{$tt->mahosotdkt}}','{{$inputs['madonvi']}}')" class="btn btn-sm btn-clean btn-icon" data-target="#trans-modal" data-toggle="modal">
                                                <i class="icon-lg la fa-send"></i></button>
                                        @endif
                                    @endif
                                    ...
                                    @if($tt->trangthai == 'BTL')
                                        <button title="Lý do hồ sơ bị trả lại" type="button" onclick="viewLiDo('{{$tt->mahosotdkt}}','{{$inputs['madonvi']}}')" class="btn btn-sm btn-clean btn-icon" data-target="#lydo-show" data-toggle="modal">
                                            <i class="icon-lg la fa-archive"></i></button>
                                    @endif
